...
class TestSIConvertion(unittest.TestCase):
    ...
    def test_convert_line_params(self):
        ...
        resize_factor = 10
        pixel_spacing = {'x': 1, 'y': 1}
        self.assertEqual(line_to_si(line_params, resize_factor, pixel_spacing)[0], np.sqrt(2))
    ...
    def test_scope_to_si(self):
        ...
        resize_factor = 1
        pixel_spacing = {'x': 1, 'y': 1}
        self.assertEqual(scope_to_si(scope_params, resize_factor, pixel_spacing)[0], 4.0)
        ...
        resize_factor = 1
        pixel_spacing = {'x': 1, 'y': 2}
        self.assertEqual(scope_to_si(scope_params, resize_factor, pixel_spacing)[0], 6.0)
